...
// Importing images from Hero-section folder based on your file tree
import Hero from "../Components/Hero";

import cardiacScreeningImg from "../assets/Hero-section/Cardiac-Screening.png";
import heartFailureImg from "../assets/Hero-section/Hypertension-care.png";
import hypertensionImg from "../assets/Hero-section/hypertension.png";
import Preventiccardiology from "../assets/Hero-section/preventive-cardiology.png";
import PostOperativeRecovery from "../assets/Hero-section/post-operative-recovery.png";
import EmergencyService from "../assets/Hero-section/emergency-support.png";

// Importing data from your data file
import {
  stats,
  services,
  features,
...
const Home = () => {
  // Map local imported images to services data so they show up correctly
  ...
  const duplicatedServices = [...updatedServices, ...updatedServices, ...updatedServices];
  ...
  const fallbackIcons = [ShieldCheck, HeartPulse, Stethoscope];
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between pb-[45px] gap-6">
            <div className="max-w-[700px]">
              ...
              <p className="m-0 text-[15px] sm:text-[16px] leading-[1.7] text-[#59636A] dark:text-gray-300">
                Uncompromising standards of medical excellence and patient-centered hospitality.
              </p>
            </div>
            ...
            >
              {features.map((feature, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="group relative flex flex-col justify-between rounded-[20px] border border-[#d0e4e1] dark:border-gray-800 bg-white dark:bg-[#111827] p-[32px] w-[85vw] sm:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)] min-h-[250px] shadow-[0_8px_30px_rgba(36,84,80,0.06)] transition-all duration-300 hover:-translate-y-[8px] hover:border-[#006B63] dark:hover:border-[#2dd4bf] overflow-hidden flex-shrink-0"
                  >
                    <span className="absolute right-4 top-2 text-[70px] font-extrabold text-[#edf4f3] dark:text-gray-800/40 select-none pointer-events-none">
                      {stepNumber}
                    </span>

                    <div>
                      <div className="flex items-center justify-between mb-6">
                        <div className="w-[52px] h-[52px] flex items-center justify-center rounded-[14px] bg-[#f0f7f6] dark:bg-[#1f2937] text-[#006B63] dark:text-[#2dd4bf] group-hover:bg-[#006B63] group-hover:text-white shadow-sm">
                      ...
                      <h3 className="mb-2 text-[18px] sm:text-[19px] font-bold text-[#16263D] dark:text-white group-hover:text-[#006B63]">
                        {feature.title}
                      </h3>
            ...
            <div className="flex items-center justify-between md:justify-end w-full md:w-auto gap-4">
              <div className="flex gap-3">
                <button
                  ...
                  className="flex h-[45px] w-[45px] items-center justify-center rounded-full border border-[#D5DDDF] dark:border-gray-700 bg-white dark:bg-[#1e293b] text-[#16263D] dark:text-gray-200 shadow-sm hover:border-[#006B63] hover:bg-[#006B63] hover:text-[#FFFFFF] cursor-pointer"
          ...
          >
            ...
            >
              {duplicatedServices.map((service, index) => (
                <div
                  key={index}
                  className="group relative rounded-[24px] overflow-hidden w-[85vw] sm:w-[360px] md:w-[370px] h-[460px] flex flex-col justify-end shadow-[0_10px_30px_rgba(16,36,61,0.08)] transition-all duration-300 hover:-translate-y-[6px] hover:shadow-[0_20px_40px_rgba(16,36,61,0.15)] flex-shrink-0 bg-gray-900"
                >
                  <img
                    src={service.image}
                    alt={service.title}
      ...
      >
        <div className="mx-auto max-w-[1200px] px-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between pb-[45px] gap-6">
            ...
            <div className="flex items-center gap-2 bg-white dark:bg-[#111827] px-4 py-2 rounded-full shadow-[0_4px_15px_rgba(16,36,61,0.05)] border border-gray-100 dark:border-gray-800">
          ...
          >
            ...
            >
              {duplicatedPatients.map((patient, index) => (
                <div
                  key={index}
                  className="flex flex-col justify-between w-[85vw] sm:w-[360px] md:w-[370px] min-h-[260px] rounded-[20px] border border-gray-100 dark:border-gray-800 bg-white dark:bg-[#111827] p-[32px] shadow-[0_10px_30px_rgba(16,36,61,0.06)] flex-shrink-0"
                >
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8 lg:gap-12">
            <div className="flex flex-col max-w-[620px]">
              ...
              <p className="text-[15px] sm:text-[17px] leading-[1.7] text-[#B4DFDC]">
                Take the first step toward better heart health today. Our scheduling assistant is available 24/7.
              </p>
            </div>
            ...
            <div className="w-full lg:w-auto flex justify-start lg:justify-end">
              ...
              >
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#E6F4F3] dark:bg-teal-950 text-[#006B63]">
                  <CalendarDays size={18} strokeWidth={2.2} />
                </div>
                <span>Book Appointment</span>
                <ArrowRight size={18} strokeWidth={2.5} className="transform transition-transform duration-300 group-hover:translate-x-1" />
              </MotionLink>
            </div>
          </div>
        </motion.div>
